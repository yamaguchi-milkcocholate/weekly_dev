...
scripts/run_blender.sh --background <input_dir>/scene.blend \
  --python .claude/skills/blender-camera-render/scripts/extract_cameras.py -- <output_dir>
```
...
```bash
scripts/run_blender.sh --background <input_dir>/scene.blend \
  --python .claude/skills/blender-camera-render/scripts/render_cameras.py -- <output_dir>
```
