...
scripts/run_blender.sh --background <workdir>/input/scene.blend \
  --python .claude/skills/v2v-camera-cuts/scripts/extract_room_bounds.py -- \
...
```bash
scripts/run_blender.sh --background <workdir>/input/scene.blend \
  --python .claude/skills/v2v-camera-cuts/scripts/render_overhead.py -- \
...
```bash
scripts/run_blender.sh --background <workdir>/input/scene.blend \
  --python .claude/skills/v2v-camera-cuts/scripts/place_cut_cameras.py -- \
...
```bash
scripts/run_blender.sh --background <workdir>/input/scene.blend \
  --python .claude/skills/v2v-camera-cuts/scripts/setup_cut_animation.py -- \
  --cuts <workdir>/output/cuts.json \
...
```bash
scripts/run_blender.sh --background <workdir>/input/scene.blend \
  --python .claude/skills/v2v-camera-cuts/scripts/render_cuts.py -- \
  --cuts <workdir>/output/cuts.json \
