...
| T1-2 | Intelligence Engine                       | 3.2章, 7章       | YouTube API収集、Whisper文字起こし、GPT-4o Visionフレーム分析、トレンドJSON集約  | T0-1           |
...
| T1-5 | Scenario Engine                           | 3.3章            | LLM(Gemini/GPT-4o)でシナリオ・テロップ・プロンプト生成、Structured Output制御    | T0-1           |
