...
- サブタスクへの分解後、各タスクの実装詳細は個別の設計書（`/docs/designs/xx_spec.md`）に記載する。
...
| **3. Asset Generator**     | キャラクター・背景・小物のリファレンス画像生成             | Midjourney / Stable Diffusion / DALL-E 3     |
...
| Runway Gen-3       | 映像クオリティ       | プロンプト追従性、一貫性         |
